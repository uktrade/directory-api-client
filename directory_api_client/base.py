...
class BaseAPIClient:
    ...
    def put(self, url, data, sso_id=None):
        return self.request(
            url=url,
            method="PUT",
    ...
    def patch(self, url, data, files=None, sso_id=None):
        if files:
    ...
    def get(self, url, params=None, sso_id=None):
        return self.request(
            url=url,
            method="GET",
            params=params,
    ...
    def post(self, url, data, files=None, sso_id=None):
        if files:
            response = self.request(
                url=url,
                method="POST",
    ...
    def delete(self, url, data=None, sso_id=None):
        return self.request(url=url, method="DELETE", sso_id=sso_id)

    def request(
        self, method, url, content_type=None, data=None, params=None,
        files=None, sso_id=None
    ):
